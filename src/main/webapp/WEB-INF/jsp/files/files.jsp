				...
				<main class="col-xs-10 col-xs-offset-2">
					<div class="row">
						<div class="col-xs-5 col-xs-offset-3">
							<h2>Lista de arquivos RDF disponíveis</h2>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-3">
							<h4><i>Arquivos RDF/XML</i></h4>
							<ul>
								<c:forEach var="file_name" items="${file_rdf_names}">
									<li><a target=_blank href="resource/rdf/${file_name}"> ${file_name} </a></li>
								</c:forEach>
							</ul>						
						</div>
					</div>
					<div class="row">
						<div class="col-xs-3">
							<h4><i>Arquivos Turtle</i></h4>
							<ul>
								<c:forEach var="file_name" items="${file_ttl_names}">
									<li><a target=_blank href="resource/rdf/${file_name}"> ${file_name} </a></li>
								</c:forEach>
							</ul>	
						</div>
